...
import { Home, User, CheckSquare, Calendar, LogOut, Settings } from 'lucide-react';
    ...
    <aside className="flex flex-col w-64 h-screen px-4 py-8 overflow-y-auto bg-base-200 border-r rtl:border-r-0 rtl:border-l dark:bg-neutral-focus dark:border-neutral">
      ...
      <div className="flex flex-col justify-between flex-1 mt-6">
        ...
        <div className="flex items-center px-4 -mx-2">
          ...
          <Link to="/settings" className="flex items-center mx-2">
              <Settings className="w-6 h-6" />
          </Link>
          <button onClick={handleLogout} className="flex items-center mx-2">
